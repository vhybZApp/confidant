...
func TestOpenAIMindWithEmptyRequest(t *testing.T) {
	...
	mind := NewMind(conf.AzurOpenAIConf.URL, conf.AzurOpenAIConf.Key, conf.TemplatePath, nil)
...
func TestOpenChrome(t *testing.T) {
	...
	mind := NewMind(conf.AzurOpenAIConf.URL, conf.AzurOpenAIConf.Key, conf.TemplatePath, mvi)
